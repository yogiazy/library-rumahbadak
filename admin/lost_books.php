<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							<a href="book_print2.php" target="_blank" style="background:none;">
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Book List</button>
							</a>
							<a href="print_barcode12.php" target="_blank" style="background:none;">
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($con,"select * from book where status = 'Lost' ") or die (mysqli_error());

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					?>
							...
							<a href="returned_report.php"><button class="btn btn-danger"><i class="fa fa-info"></i> Returned Reports (<?php echo $count2['total']; ?>)</button></a>
						</span>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							where detail_action = 'Returned Book'
